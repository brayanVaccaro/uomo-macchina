    ...
    computed: {
        ...
        calcoloOreTotali() {
            if (this.toModify === null)
                return 0;
            if (this.oraInizio === 0 || this.oraFine === 0 || this.toModify["oreTotali"] == null)
                return 0;
